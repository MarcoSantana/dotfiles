...
before packages are loaded."
  ...
  (setq lsp-enable-snippet t
        lsp-ui-doc-enable nil            ; Disable all popups/overlays
        lsp-ui-sideline-enable nil       ; Disable sideline information
        lsp-eldoc-render-all t)          ; Keep only minibuffer documentation
